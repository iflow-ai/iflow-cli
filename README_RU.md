...
4. **Открытая платформа**: Установка SubAgent и MCP одним кликом из [открытого рынка iFlow](https://platform.iflow.cn/)
...
* Интеграция с открытым рынком iFlow. Быстрая установка полезных инструментов MCP, Subagents и пользовательских инструкций. Используйте /mcp для получения дополнительной информации
